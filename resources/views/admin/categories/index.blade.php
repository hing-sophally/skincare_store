                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <th class="border-0" width="20%">Name</th>
                                <th class="border-0" width="30%">Description</th>
                                <th class="text-center border-0" width="10%">Image</th>
                                <th class="text-center border-0" width="12%">Created</th>
                                <th class="text-center border-0" width="12%">Updated</th>
                                <th class="text-center border-0" width="11%">Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <td class="text-center">
                                        @if($category->image_url)
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('storage/' . $category->image_url) }}" alt="{{ $category->name }}" class="avatar-img rounded-circle">
                                            </div>
                                        @else
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="empty-state">
                                            ...
                                            <p class="text-muted mb-4">Start by creating your first category to organize your products.</p>
