                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-gradient-primary text-white">
                            <h5 class="card-title mb-0">
                                <i class="fas fa-user-shield me-2"></i>Skincare Tip Information
                            </h5>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('admin.skincaretips.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="tip_content"
                                              ...
                                              required>{{ old('tip_content') }}</textarea>
                                    @error('tip_content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg px-4 ms-2">
                                            <i class="fas fa-save me-2"></i>Create Skincare Tip
                                        </button>
                                    </div>
                                </div>
                            </form>
